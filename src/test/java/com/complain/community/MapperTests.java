...
import com.complain.community.dao.MessageMapper;
...
public class MapperTests {
    ...
    public void testSelectUser() {
        ...
        user = userMapper.selectByEmail("complain101@sina.com");
        System.out.println(user);
    }
    ...
    public void testInsertUser() {
        ...
        user.setHeaderUrl("http://www.complain.com/101.png");
    ...
    public void updateUser() {
        ...
        rows = userMapper.updateHeader(150, "http://www.complain.com/102.png");
        System.out.println(rows);
