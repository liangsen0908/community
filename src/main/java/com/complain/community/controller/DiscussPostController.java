...
public class DiscussPostController implements CommunityConstant {
    ...
    public String getDiscussPst(@PathVariable("discussPostId") int discussPostId, Model model, Page page){
        ...
        //评论：给帖子的评论
        //回复：给评论的评论
        List<Comment> commentByEntityList = commentService.findCommentsByEntity(ENTITY_TYPE_POST, post.getId(), page.getOffset(), page.getLimit());
        //评论的VO表
        List<Map<String,Object>> commentVoList = new ArrayList<>();
        if (commentByEntityList != null){
            for (Comment comment:commentByEntityList){
                //评论VO
